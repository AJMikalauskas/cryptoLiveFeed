...
var yValues = [];
  ...
  // var firstParamValue = specificStringParam.slice(12, endOfFirstParam);
  // console.log(firstParamValue);
  var valueForApiCall = specificStringParam.slice(12, specificStringParam.indexOf("&"));
...
function creatingALineChartForSpecificCrypto() {
  ...
  xhr2.open(
    "GET",
    "https://coingecko.p.rapidapi.com/coins/" + valueForApiCall +"/market_chart?vs_currency=usd&days=7"
  );
